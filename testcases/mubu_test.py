...
class TestCaseMubu(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunRequest("/doc7h1C5NyaE4Y")
            .get("https://mubu.com/doc7h1C5NyaE4Y")
            .with_headers(
                **{
                    "upgrade-insecure-requests": "1",
                    "user-agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.121 Safari/537.36",
        ...
        Step(
            ...
            .with_json({"document_id": "7h1C5NyaE4Y"})
            .validate()
            .assert_equal("status_code", 200)
            .assert_equal("body.code", 0)
        ),
        ...
        Step(
            ...
            .with_params(
                **{"memberId": "2753800615995680", "documentId": "7h1C5NyaE4Y"}
            )
            .with_headers(
                **{
                    "accept": "*/*",
        ...
        Step(
            ...
            .with_json({"documentId": "7h1C5NyaE4Y", "keywords": ""})
            .validate()
            .assert_equal("status_code", 200)
            .assert_equal("body.code", 0)
        ),
        ...
        Step(
            ...
            .with_headers(
                **{
                    ...
                    "sec-fetch-user": "?1",
                    "sec-fetch-dest": "document",
                    "referer": "https://mubu.com/doc7h1C5NyaE4Y",
                    "accept-encoding": "gzip, deflate, br",
                    "accept-language": "en-US,en;q=0.9",
                }
            )
